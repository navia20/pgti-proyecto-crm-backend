# Integración Analítica → CRM: Consulta de Estado
...
```
GET https://pgti-proyecto-crm-backend.vercel.app/api/v1/analytics/estado-ticket/:id
```

Local:
```
GET http://localhost:3001/api/v1/analytics/estado-ticket/:id
```
...
|---|---|---|---|
| `api_key` | `string` | Sí | API key de Analítica: `analytics_secret_p07` |
...
```
GET https://pgti-proyecto-crm-backend.vercel.app/api/v1/analytics/estado-ticket/bbd7fb0e-5aa1-4b6a-8bb1-3216ea8fd057?api_key=analytics_secret_p07
```
...
```
ANALYTICS_API_KEY=analytics_secret_p07
```
...
```javascript
// Consultar estado de un ticket desde Analítica
const ticketId = "bbd7fb0e-5aa1-4b6a-8bb1-3216ea8fd057";
const apiKey = "analytics_secret_p07";

const response = await fetch(
  `https://pgti-proyecto-crm-backend.vercel.app/api/v1/analytics/estado-ticket/${ticketId}?api_key=${apiKey}`
);
...
api_key = "analytics_secret_p07"

response = requests.get(
    f"https://pgti-proyecto-crm-backend.vercel.app/api/v1/analytics/estado-ticket/{ticket_id}",
